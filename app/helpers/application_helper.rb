  ...
  def fb_meta_tags(controller_name, action_name, contestant_profile)
    if controller_name == "contents" && action_name == "history"
      set_meta_tags og: {
        ...
        image:  "http://res.cloudinary.com/miss-someone/image/upload/v1447324222/history_mainimage_s9z5cl.jpg"
      }
      ...
      set_meta_tags og: {
        ...
        image: "http://res.cloudinary.com/miss-someone/image/upload/v1447324228/interview_mainimage_ql7aw3.jpg"
      }
